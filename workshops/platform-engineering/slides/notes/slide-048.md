...
For fault 4, use the pair version by default; let learners who already have a trusted agent opt in without holding the room. Budget guidance: ~8 minutes on fault 1, the rest on fault 4.

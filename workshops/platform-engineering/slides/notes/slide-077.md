...
The eighth card is our addition and the day's punchline: Team Topologies' "Thinnest Viable Platform" — the smallest thing that still counts as a real platform. Ours runs inside one reproducible Intar workspace.

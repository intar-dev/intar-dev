...
1. Docker on your learner VM is the "datacenter".
...
3. Gitea + ArgoCD are the heart (module 02): the git server lives IN the cluster, and ArgoCD delivers everything below it from that git repo. The GitOps loop does not depend on GitHub; Intar connectivity and registry egress remain explicit.

...
"At the end of these four hours, your persistent Intar workspace is running the complete cloud platform Bruktby moved to — Kubernetes, GitOps, a managed database, S3-compatible storage, a self-service API, serverless, a portal — with their photo pipeline live on top of it. No trial account, no free tier, no vendor runtime dependency."

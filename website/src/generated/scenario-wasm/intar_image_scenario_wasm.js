/* @ts-self-types="./intar_image_scenario_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function content_hash(input_json) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function validate(scenario_hcl) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(scenario_hcl, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./intar_image_scenario_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('intar_image_scenario_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

...
export interface WorkshopManifestV1 {
  ...
  modules: Array<{
    ...
    hints: Array<{ id: string; title?: string; bodyMarkdown: string }>;
  ...
  agenda: Array<{
    ...
    moduleId?: string;
    slideIds: string[];
    release: "facilitator" | "automatic" | "pool";
  }>;
  presentation: {
    slides: Array<{
      id: string;
      layout: "title" | "content" | "two_column" | "image" | "quote";
      title?: string;
      bodyMarkdown: string;
...
export const workshopTemplateRevisions = sqliteTable(
  "workshop_template_revisions",
  {
    ...
    manifestJson: jsonText<WorkshopManifestV1>("manifest_json").notNull(),

...
const EXPECTED_RAW_TREE_SHA256 =
  "2da929a35bbb64a9543b322c65bd252bd2f67b6acd6d3758964a80773937043f";
const EXPECTED_ADAPTED_TREE_SHA256 =
  "ed62e0ada8e201e6a9777b6aab2a1b7baa497c03d50091c1624c6dab2ef8421d";
...
if (!process.argv[2] || !process.argv[3]) {
  throw new Error(
    "usage: bun tools/workshops/platform-engineering/verify-lock.ts RAW_IMPORT ADAPTED_TREE",
  );
}

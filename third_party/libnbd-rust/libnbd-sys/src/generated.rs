...
pub struct nbd_chunk_callback {
    pub callback: Option<
        unsafe extern "C" fn(*mut c_void, *const c_void, usize, u64, c_uint, *mut c_int) -> c_int,
    >,
...
pub struct nbd_completion_callback {
    pub callback: Option<unsafe extern "C" fn(*mut c_void, *mut c_int) -> c_int>,
    pub user_data: *mut c_void,
    pub free: Option<unsafe extern "C" fn(*mut c_void)>,
}
#[repr(C)]
...
pub struct nbd_debug_callback {
    pub callback: Option<unsafe extern "C" fn(*mut c_void, *const c_char, *const c_char) -> c_int>,
    pub user_data: *mut c_void,
    pub free: Option<unsafe extern "C" fn(*mut c_void)>,
}
#[repr(C)]
...
pub struct nbd_extent_callback {
    pub callback: Option<
        unsafe extern "C" fn(*mut c_void, *const c_char, u64, *mut u32, usize, *mut c_int) -> c_int,
    >,
    pub user_data: *mut c_void,
    pub free: Option<unsafe extern "C" fn(*mut c_void)>,
}
...
pub struct nbd_context_callback {
    pub callback: Option<unsafe extern "C" fn(*mut c_void, *const c_char) -> c_int>,
    pub user_data: *mut c_void,
    pub free: Option<unsafe extern "C" fn(*mut c_void)>,
}
extern "C" {
    ...
    pub fn nbd_set_debug_callback(handle: *mut nbd_handle, debug: nbd_debug_callback) -> c_int;
    ...
    pub fn nbd_set_handle_name(handle: *mut nbd_handle, handle_name: *const c_char) -> c_int;
    pub fn nbd_get_handle_name(handle: *mut nbd_handle) -> *mut c_char;
    pub fn nbd_set_private_data(handle: *mut nbd_handle, private_data: uintptr_t) -> uintptr_t;
    pub fn nbd_get_private_data(handle: *mut nbd_handle) -> uintptr_t;
    pub fn nbd_set_export_name(handle: *mut nbd_handle, export_name: *const c_char) -> c_int;
    pub fn nbd_get_export_name(handle: *mut nbd_handle) -> *mut c_char;
    pub fn nbd_set_request_block_size(handle: *mut nbd_handle, request: bool) -> c_int;
    ...
    pub fn nbd_get_canonical_export_name(handle: *mut nbd_handle) -> *mut c_char;
    ...
    pub fn nbd_set_tls_certificates(handle: *mut nbd_handle, dir: *const c_char) -> c_int;
    pub fn nbd_set_tls_verify_peer(handle: *mut nbd_handle, verify: bool) -> c_int;
    pub fn nbd_get_tls_verify_peer(handle: *mut nbd_handle) -> c_int;
    pub fn nbd_set_tls_username(handle: *mut nbd_handle, username: *const c_char) -> c_int;
    pub fn nbd_get_tls_username(handle: *mut nbd_handle) -> *mut c_char;
    pub fn nbd_set_tls_hostname(handle: *mut nbd_handle, hostname: *const c_char) -> c_int;
    pub fn nbd_get_tls_hostname(handle: *mut nbd_handle) -> *mut c_char;
    pub fn nbd_set_tls_psk_file(handle: *mut nbd_handle, filename: *const c_char) -> c_int;
    pub fn nbd_set_request_extended_headers(handle: *mut nbd_handle, request: bool) -> c_int;
    pub fn nbd_get_request_extended_headers(handle: *mut nbd_handle) -> c_int;
    pub fn nbd_get_extended_headers_negotiated(handle: *mut nbd_handle) -> c_int;
    pub fn nbd_set_request_structured_replies(handle: *mut nbd_handle, request: bool) -> c_int;
    pub fn nbd_get_request_structured_replies(handle: *mut nbd_handle) -> c_int;
    pub fn nbd_get_structured_replies_negotiated(handle: *mut nbd_handle) -> c_int;
    pub fn nbd_set_request_meta_context(handle: *mut nbd_handle, request: bool) -> c_int;
    pub fn nbd_get_request_meta_context(handle: *mut nbd_handle) -> c_int;
    pub fn nbd_set_handshake_flags(handle: *mut nbd_handle, flags: u32) -> c_int;
    pub fn nbd_get_handshake_flags(handle: *mut nbd_handle) -> u32;
    pub fn nbd_set_pread_initialize(handle: *mut nbd_handle, request: bool) -> c_int;
    ...
    pub fn nbd_opt_list(handle: *mut nbd_handle, list: nbd_list_callback) -> c_int;
    ...
    pub fn nbd_add_meta_context(handle: *mut nbd_handle, name: *const c_char) -> c_int;
    pub fn nbd_get_nr_meta_contexts(handle: *mut nbd_handle) -> isize;
    pub fn nbd_get_meta_context(handle: *mut nbd_handle, i: size_t) -> *mut c_char;
    pub fn nbd_clear_meta_contexts(handle: *mut nbd_handle) -> c_int;
    pub fn nbd_set_uri_allow_transports(handle: *mut nbd_handle, mask: u32) -> c_int;
    pub fn nbd_set_uri_allow_tls(handle: *mut nbd_handle, tls: c_int) -> c_int;
    pub fn nbd_set_uri_allow_local_file(handle: *mut nbd_handle, allow: bool) -> c_int;
    pub fn nbd_connect_uri(handle: *mut nbd_handle, uri: *const c_char) -> c_int;
    pub fn nbd_connect_unix(handle: *mut nbd_handle, unixsocket: *const c_char) -> c_int;
    pub fn nbd_connect_vsock(handle: *mut nbd_handle, cid: u32, port: u32) -> c_int;
    ...
    pub fn nbd_connect_command(handle: *mut nbd_handle, argv: *mut *mut c_char) -> c_int;
    ...
    pub fn nbd_get_socket_activation_name(handle: *mut nbd_handle) -> *mut c_char;
    ...
    pub fn nbd_can_meta_context(handle: *mut nbd_handle, metacontext: *const c_char) -> c_int;
    pub fn nbd_get_protocol(handle: *mut nbd_handle) -> *const c_char;
    pub fn nbd_get_size(handle: *mut nbd_handle) -> i64;
    pub fn nbd_get_block_size(handle: *mut nbd_handle, size_type: c_int) -> i64;
    pub fn nbd_pread(
        handle: *mut nbd_handle,
        buf: *mut c_void,
        count: usize,
    ...
    pub fn nbd_trim(handle: *mut nbd_handle, count: u64, offset: u64, flags: u32) -> c_int;
    pub fn nbd_cache(handle: *mut nbd_handle, count: u64, offset: u64, flags: u32) -> c_int;
    pub fn nbd_zero(handle: *mut nbd_handle, count: u64, offset: u64, flags: u32) -> c_int;
    ...
    pub fn nbd_poll2(handle: *mut nbd_handle, fd: c_int, timeout: c_int) -> c_int;
    pub fn nbd_aio_connect(
        handle: *mut nbd_handle,
        addr: *const sockaddr,
        addrlen: socklen_t,
    ) -> c_int;
    pub fn nbd_aio_connect_uri(handle: *mut nbd_handle, uri: *const c_char) -> c_int;
    pub fn nbd_aio_connect_unix(handle: *mut nbd_handle, unixsocket: *const c_char) -> c_int;
    pub fn nbd_aio_connect_vsock(handle: *mut nbd_handle, cid: u32, port: u32) -> c_int;
    pub fn nbd_aio_connect_tcp(
        handle: *mut nbd_handle,
        hostname: *const c_char,
        port: *const c_char,
    ) -> c_int;
    pub fn nbd_aio_connect_socket(handle: *mut nbd_handle, sock: c_int) -> c_int;
    pub fn nbd_aio_connect_command(handle: *mut nbd_handle, argv: *mut *mut c_char) -> c_int;
    pub fn nbd_aio_connect_systemd_socket_activation(
        handle: *mut nbd_handle,
        argv: *mut *mut c_char,
    ) -> c_int;
    pub fn nbd_aio_opt_go(handle: *mut nbd_handle, completion: nbd_completion_callback) -> c_int;
    ...
    pub fn nbd_aio_opt_info(handle: *mut nbd_handle, completion: nbd_completion_callback) -> c_int;
    ...
    pub fn nbd_aio_command_completed(handle: *mut nbd_handle, cookie: u64) -> c_int;
    ...
    pub fn nbd_kill_subprocess(handle: *mut nbd_handle, signum: c_int) -> c_int;
    pub fn nbd_get_subprocess_pid(handle: *mut nbd_handle) -> i64;
    ...
    pub fn nbd_is_uri(handle: *mut nbd_handle, uri: *const c_char) -> c_int;
}

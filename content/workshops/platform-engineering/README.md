...
Run `just hydrate-workshops` from the repository root. The generated v2
Workshop is written to `.work/workshops/platform-engineering`; validation and
publication consume that directory. CI repeats hydration and checks the entire
raw tree, adapted tree, changed-file count, source license, and all digests.
